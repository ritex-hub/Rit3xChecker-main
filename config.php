...
$site_name = 'Rit3x';
$site_icon = 'assets/img/Tikol4Life.png';
$owner = 'Rit3x';
...
$bot_name = "Rit3x Bot"; //change this to any bot name you want.
$bot_token = "5362044922:AAHd9OyQRnBhaW7wKOIlxzZDE18A-jJ6M7Y"; //change this to your own bot Token.
...
$api_name[] = 'Stripe API 3 [need SK][Risk: Low]';
$api_file[] = 'Stripe_3_New.php';

$api_name[] = 'Stripe API 4 [need SK][Risk: High]';
