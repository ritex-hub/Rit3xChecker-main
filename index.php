...
<body onload="ccgen();  onLoadChks();"style="background: <?php echo $theme_background ?>;">
	<div class="container" id="container">
		...
		<div class="footer" id="footer"><center><p style="color: <?php echo $theme_text ?>">Rit3x</p></center></div>
	</div>
				...
				<div class="modal-body" style="background: <?php echo $theme_background ?>">
					...
					<div name="howto" id="howto">
						<center >
							...
							<h6 style="color: <?php echo $theme_text ?>;">[1] Open our Telegram Bot: <a href="https://t.me/Rit3xBot" target="_blank">@Rit3xBot</a>.
